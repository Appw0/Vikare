...
public class ShinyWingsRecipe extends CustomRecipe {
    ...
    public ShinyWingsRecipe(ResourceLocation resourceLocation, CraftingBookCategory category) { super(resourceLocation, category); }
    ...
    @Override
    public @NotNull ItemStack assemble(CraftingContainer inv, RegistryAccess reg) {
    ...
    @Override
    public @NotNull RecipeSerializer<?> getSerializer() { return RecipeSerializers.SHINY_WINGS.get(); }
}
