...
public class LightWingsModel extends WingsModel {
    ...
    public LightWingsModel()
    {
        ...
        rWing01.setTextureOffset(26, 18).addBox(-1.0F, -4.0F, 0.0F, 2, 13, 0,true);
//        rWing01.setTextureOffset(26, 18).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 13.0F, 0.001F, 0.0F, true);
        ...
        rWing02.setTextureOffset(25, 12).addBox(-1.5F, -4.0F, 0.0F, 3, 19, 0,true);
//        rWing02.setTextureOffset(25, 12).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 19.0F, 0.001F, 0.0F, true);
        ...
        rWing03.setTextureOffset(25, 8).addBox(-1.5F, -4.0F, 0.0F, 3, 23, 0,true);
//        rWing03.setTextureOffset(25, 8).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 23.0F, 0.001F, 0.0F, true);
        ...
        rWing04.setTextureOffset(19, 16).addBox(-1.0F, -4.0F, 0.0F, 2, 15, 0,true);
//        rWing04.setTextureOffset(19, 16).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 15.0F, 0.001F, 0.0F, true);
        ...
        rWing05.setTextureOffset(12, 21).addBox(-0.5F, -2.0F, 0.0F, 2, 10, 0,true);
//        rWing05.setTextureOffset(12, 21).addBox(-0.5F, -2.0F, 0.0F, 2.0F, 10.0F, 0.001F, 0.0F, true);
        ...
        lWing01.setTextureOffset(26, 18).addBox(-1.0F, -4.0F, 0.0F, 2, 13, 0,false);
//        lWing01.setTextureOffset(26, 18).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 13.0F, 0.001F, 0.0F, false);
        ...
        lWing02.setTextureOffset(25, 12).addBox(-1.5F, -4.0F, 0.0F, 3, 19, 0,false);
//        lWing02.setTextureOffset(25, 12).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 19.0F, 0.001F, 0.0F, false);
        ...
        lWing03.setTextureOffset(25, 8).addBox(-1.5F, -4.0F, 0.0F, 3, 23, 0,false);
//        lWing03.setTextureOffset(25, 8).addBox(-1.5F, -4.0F, 0.0F, 3.0F, 23.0F, 0.001F, 0.0F, false);
        ...
        lWing04.setTextureOffset(19, 16).addBox(-1.0F, -4.0F, 0.0F, 2, 15, 0,false);
//        lWing04.setTextureOffset(19, 16).addBox(-1.0F, -4.0F, 0.0F, 2.0F, 15.0F, 0.001F, 0.0F, false);
        ...
        lWing05.setTextureOffset(12, 21).addBox(-1.5F, -2.0F, 0.0F, 2, 10, 0,false);
//        lWing05.setTextureOffset(12, 21).addBox(-1.5F, -2.0F, 0.0F, 2.0F, 10.0F, 0.001F, 0.0F, false);
    }
