...
public class ZanzasWingsModel<T extends LivingEntity> extends WingsModel<T> {
    ...
    public ZanzasWingsModel()
    {
        ...
        lWing01.setTextureOffset(0, 18).addBox(0.0F, -5.0F, 0.25F, 14.0F, 15.0F, 0.0F, 0.0F, false);
        ...
        lWing02.setTextureOffset(29, 17).addBox(0.0F, -6.0F, 0.25F, 17.0F, 17.0F, 0.0F, 0.0F, false);
        ...
        cube_r1.setTextureOffset(0, 34).addBox(-7.5F, -8.5F, 0.25F, 13.0F, 13.0F, 0.0F, 0.0F, false);

        rWing01 = new ModelRenderer(this);
        rWing01.setRotationPoint(6.0F, 0.0F, 0.0F);
        setRotationAngle(rWing01, 0.0F, 0.0F, -0.436332F);
        rWing01.setTextureOffset(0, 18).addBox(-14.0F, -5.0F, 0.25F, 14.0F, 15.0F, 0.0F, 0.0F, true);
        ...
        rWing02.setTextureOffset(29, 17).addBox(-17.0F, -6.0F, 0.25F, 17.0F, 17.0F, 0.0F, 0.0F, true);
        ...
        cube_r2.setTextureOffset(0, 34).addBox(-5.5F, -8.5F, 0.25F, 13.0F, 13.0F, 0.0F, 0.0F, true);
    }
