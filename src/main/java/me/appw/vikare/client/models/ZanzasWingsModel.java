...
public class ZanzasWingsModel extends WingsModel {
    ...
    public ZanzasWingsModel()
    {
        ...
        lWing01.setTextureOffset(0, 18);
        lWing01.cubeList.add(new ModelBoxPatched(lWing01, 0, 18, 0.0F, -5.0F, 0.25F, 14.0F, 15.0F, 0.001F, 0.0F, false));
        ...
        lWing02.setTextureOffset(29, 17);
        lWing02.cubeList.add(new ModelBoxPatched(lWing02, 29, 17, 0.0F, -6.0F, 0.25F, 17.0F, 17.0F, 0.001F, 0.0F, false));
        ...
        cube_r1.setTextureOffset(0, 34);
        cube_r1.cubeList.add(new ModelBoxPatched(cube_r1, 0, 34, -7.5F, -8.5F, 0.25F, 13.0F, 13.0F, 0.001F, 0.0F, false));

        rWing01 = new ModelRenderer(this);
        rWing01.setRotationPoint(6.0F, 0.0F, 0.0F);
        setRotationAngle(rWing01, 0.0F, 0.0F, -0.436332F);
        rWing01.setTextureOffset(0, 18);
        rWing01.cubeList.add(new ModelBoxPatched(rWing01, 0, 18, -14.0F, -5.0F, 0.25F, 14.0F, 15.0F, 0.001F, 0.0F, true));
        ...
        rWing02.setTextureOffset(29, 17);
        rWing02.cubeList.add(new ModelBoxPatched(rWing02, 29, 17, -17.0F, -6.0F, 0.25F, 17.0F, 17.0F, 0.001F, 0.0F, true));
        ...
        cube_r2.setTextureOffset(0, 34);
        cube_r2.cubeList.add(new ModelBoxPatched(cube_r2, 0, 34, -5.5F, -8.5F, 0.25F, 13.0F, 13.0F, 0.001F, 0.0F, true));
    }
