...
// copied from net.minecraft.client.model.ModelBox
public class ModelBoxPatched extends ModelBox {
    ...
    public ModelBoxPatched(ModelRenderer renderer, int texU, int texV, float x, float y, float z, float dx, float dy, float dz, float delta)
    {
        this(renderer, texU, texV, x, y, z, dx, dy, dz, delta, renderer.mirror);
    }

    public ModelBoxPatched(ModelRenderer renderer, int texU, int texV, float x, float y, float z, float dxf, float dyf, float dzf, float delta, boolean mirror)
    {
        super(renderer, texU, texV, x, y, z, (int)dxf, (int)dyf, (int)dzf, delta, mirror);
        int dx = (int)dxf;
        int dy = (int)dyf;
        int dz = (int)dzf;
        this.posX1 = x;
